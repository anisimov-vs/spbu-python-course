...
@overload
def smart_args(func: None = None, *, positional_support: bool = False) -> Callable[[Callable[P, R]], Callable[P, R]]: ...


def smart_args(func: Optional[Callable[P, R]] = None, *, positional_support: bool = False) -> Callable[P, R] | Callable[[Callable[P, R]], Callable[P, R]]:
    """
    ...
    def decorator(f: Callable[P, R]) -> Callable[P, R]:
        ...
        for name, param in sig.parameters.items():
            ...
            assert not (is_isolated and is_evaluated), "Cannot combine Isolated and Evaluated."
